...
export default function Edit({ auth, citizen }) {
    ...
    function submit(e) {
        e.preventDefault();
        put(route('citizens.update', citizen.id));
    }

    return (
        <AuthenticatedLayout
            auth={auth}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Edit Citizen</h2>}
        >
            <Head title="Edit Citizen" />
