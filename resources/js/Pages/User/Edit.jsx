                        ...
                        <div className="p-6 bg-white border-b border-gray-200">
                            <form onSubmit={submit}>
                                ...
                                <div className="mb-4">
                                    ...
                                    <input type="password" value={data.password} onChange={e => setData('password', e.target.value)} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700" placeholder="Leave blank to keep current password" />
